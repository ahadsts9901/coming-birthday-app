function seeBirthday(event) {
    ...
    // here we have our months finally! now its time for days
    ...
    let WholeTime = `${months} ${month1},  ${dates} ${day1},  ${NewHour} ${hour1},  ${NewMinute} ${minute1},  ${NewSecond} ${second1},  ${NewMilliSecond} ${millisecond1}`
